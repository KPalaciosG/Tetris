...
compile: assets/main.cc matriz.o nextTetrinomio.o
	$(CXX) $(CXXFLAGS) assets/main.cc MakefileOutputs/matriz.o MakefileOutputs/nextTetrinomio.o assets/Game.cc assets/Cerebro.cc assets/ScoresScreen.cc -o MakefileOutputs/ejecutable $(LIBS)
